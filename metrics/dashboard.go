...
func (ds *DashboardServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if ds.guiPath != "" {
		...
		// For SPA routing or root path, serve index.html
...
func (ds *DashboardServer) servePrometheusMetrics(w http.ResponseWriter, r *http.Request) {
	...
	b.Grow(4096) // Pre-allocate to reduce allocations

	b.WriteString("# HELP api_scanner_total_scans Total number of scans\n")
	b.WriteString("# TYPE api_scanner_total_scans counter\n")
	b.WriteString("# HELP api_scanner_total_endpoints Total number of endpoints tested\n")
	b.WriteString("# TYPE api_scanner_total_endpoints gauge\n")
	b.WriteString("# HELP api_scanner_total_vulnerabilities Total number of vulnerabilities\n")
	b.WriteString("# TYPE api_scanner_total_vulnerabilities gauge\n")
	b.WriteString("# HELP api_scanner_critical_vulnerabilities Number of critical vulnerabilities\n")
	b.WriteString("# TYPE api_scanner_critical_vulnerabilities gauge\n")
	b.WriteString("# HELP api_scanner_high_vulnerabilities Number of high vulnerabilities\n")
	b.WriteString("# TYPE api_scanner_high_vulnerabilities gauge\n")
	b.WriteString("# HELP api_scanner_medium_vulnerabilities Number of medium vulnerabilities\n")
	b.WriteString("# TYPE api_scanner_medium_vulnerabilities gauge\n")
	b.WriteString("# HELP api_scanner_low_vulnerabilities Number of low vulnerabilities\n")
	b.WriteString("# TYPE api_scanner_low_vulnerabilities gauge\n")
	b.WriteString("# HELP api_scanner_active_tenants Number of active tenants\n")
	b.WriteString("# TYPE api_scanner_active_tenants gauge\n")
	b.WriteString("# HELP api_scanner_avg_response_time Average response time in milliseconds\n")
	b.WriteString("# TYPE api_scanner_avg_response_time gauge\n")
	b.WriteString("# HELP api_scanner_throughput Requests per second\n")
	b.WriteString("# TYPE api_scanner_throughput gauge\n")
	b.WriteString("# HELP api_scanner_error_rate Percentage of errors\n")
	b.WriteString("# TYPE api_scanner_error_rate gauge\n")
	b.WriteString("# HELP api_scanner_cpu_usage CPU usage percentage\n")
	b.WriteString("# TYPE api_scanner_cpu_usage gauge\n")
	b.WriteString("# HELP api_scanner_memory_usage Memory usage in MB\n")
	b.WriteString("# TYPE api_scanner_memory_usage gauge\n")
	b.WriteString("# HELP api_scanner_goroutines Number of goroutines\n")
	b.WriteString("# TYPE api_scanner_goroutines gauge\n")
	b.WriteString("# HELP api_scanner_tenant_total_scans Total scans for tenant\n")
	b.WriteString("# TYPE api_scanner_tenant_total_scans gauge\n")
	b.WriteString("# HELP api_scanner_tenant_critical_vulnerabilities Critical vulnerabilities for tenant\n")
	b.WriteString("# TYPE api_scanner_tenant_critical_vulnerabilities gauge\n")
	b.WriteString("# HELP api_scanner_tenant_high_vulnerabilities High vulnerabilities for tenant\n")
	b.WriteString("# TYPE api_scanner_tenant_high_vulnerabilities gauge\n")

	if systemMetrics != nil {
		fmt.Fprintf(&b, "api_scanner_total_scans %d\n", systemMetrics.TotalScans)
		fmt.Fprintf(&b, "api_scanner_total_endpoints %d\n", systemMetrics.TotalEndpoints)
		fmt.Fprintf(&b, "api_scanner_total_vulnerabilities %d\n", systemMetrics.Vulnerabilities.Total)
		fmt.Fprintf(&b, "api_scanner_critical_vulnerabilities %d\n", systemMetrics.Vulnerabilities.Critical)
		fmt.Fprintf(&b, "api_scanner_high_vulnerabilities %d\n", systemMetrics.Vulnerabilities.High)
		fmt.Fprintf(&b, "api_scanner_medium_vulnerabilities %d\n", systemMetrics.Vulnerabilities.Medium)
		fmt.Fprintf(&b, "api_scanner_low_vulnerabilities %d\n", systemMetrics.Vulnerabilities.Low)
		fmt.Fprintf(&b, "api_scanner_active_tenants %d\n", systemMetrics.ActiveTenants)

		if systemMetrics.Performance.AvgResponseTime > 0 {
			fmt.Fprintf(&b, "api_scanner_avg_response_time %f\n", float64(systemMetrics.Performance.AvgResponseTime)/float64(time.Millisecond))
		} else {
			b.WriteString("api_scanner_avg_response_time 0.0\n")
		}

		fmt.Fprintf(&b, "api_scanner_throughput %f\n", systemMetrics.Performance.Throughput)
		fmt.Fprintf(&b, "api_scanner_error_rate %f\n", systemMetrics.Performance.ErrorRate)
		fmt.Fprintf(&b, "api_scanner_cpu_usage %f\n", systemMetrics.ResourceUsage.CPUUsage)
		fmt.Fprintf(&b, "api_scanner_memory_usage %f\n", systemMetrics.ResourceUsage.MemoryUsage)
		fmt.Fprintf(&b, "api_scanner_goroutines %d\n", systemMetrics.ResourceUsage.Goroutines)
	} else {
		b.WriteString("api_scanner_total_scans 0\n")
		b.WriteString("api_scanner_total_endpoints 0\n")
		b.WriteString("api_scanner_total_vulnerabilities 0\n")
		b.WriteString("api_scanner_critical_vulnerabilities 0\n")
		b.WriteString("api_scanner_high_vulnerabilities 0\n")
		b.WriteString("api_scanner_medium_vulnerabilities 0\n")
		b.WriteString("api_scanner_low_vulnerabilities 0\n")
		b.WriteString("api_scanner_active_tenants 0\n")
		b.WriteString("api_scanner_avg_response_time 0.0\n")
		b.WriteString("api_scanner_throughput 0.0\n")
		b.WriteString("api_scanner_error_rate 0.0\n")
		b.WriteString("api_scanner_cpu_usage 0.0\n")
		b.WriteString("api_scanner_memory_usage 0.0\n")
		b.WriteString("api_scanner_goroutines 0\n")
	}
	...
	if systemMetrics != nil && systemMetrics.TenantMetrics != nil {
		for tenantID, tenantMetrics := range systemMetrics.TenantMetrics {
			if tenantMetrics != nil {
				fmt.Fprintf(&b, `api_scanner_tenant_total_scans{tenant_id="%s"} %d`+"\n", tenantID, tenantMetrics.TotalScans)
				fmt.Fprintf(&b, `api_scanner_tenant_critical_vulnerabilities{tenant_id="%s"} %d`+"\n", tenantID, tenantMetrics.Vulnerabilities.Critical)
				fmt.Fprintf(&b, `api_scanner_tenant_high_vulnerabilities{tenant_id="%s"} %d`+"\n", tenantID, tenantMetrics.Vulnerabilities.High)
			}
		}
	} else {
		b.WriteString(`api_scanner_tenant_total_scans{tenant_id="default"} 0` + "\n")
		b.WriteString(`api_scanner_tenant_critical_vulnerabilities{tenant_id="default"} 0` + "\n")
		b.WriteString(`api_scanner_tenant_high_vulnerabilities{tenant_id="default"} 0` + "\n")
	}
